  ...
  return (
    <main style={{ margin: "10px" }}>
      ...
      <Typography variant="subtitle1" align="center">
        ...
        and many other things which comes to a cost and I need to pay for those and also I need to buy a secure domain too. so, I would be so grateful is you could donate me somewhat bucks.
        
        It would be really helpful if you could donate and help me keep doing
        what I do. Thanks…
        <br/>
          You can pay anything upto your will on this no.
          <br/>
            +91-9828243135 (for indians)
           <br/>
            If you nri, please consider to sponsor me on GitHub.
      </Typography>
