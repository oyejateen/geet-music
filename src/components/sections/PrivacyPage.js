    ...
    <Container maxWidth="sm">
      ...
      <section>
        <Typography gutterBottom={true} variant="subtitle1">
          Geet Music is an open source project built by Jatin. This SERVICE is
          provided by Jatin at no cost and is intended for use as is.
          <br />
        ...
        <Typography gutterBottom={true}>
          ...
          <Link href="mailto:jatinshrimali24@gmail.com" target="self">
          jatinshrimali24@gmail.com
          </Link>
        </Typography>
      </section>
    </Container>
